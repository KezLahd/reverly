...
// Sample landing page properties for demo
const sampleProperties: PropertyRow[] = [
  {
    id: "1",
    address: "124 Oak Street, San Francisco, CA 94102",
    last_contacted: "2024-01-15",
    method: "door",
    readiness: 85,
    next_contact: "2024-01-22",
    estimated_value: "$1,250,000",
    last_agent: "Sarah Johnson",
    agent_profile_url: "https://api.example.com/agents/sarah",
    interaction_count: 3,
    lead_status: "hot",
  ...
  },
  {
    ...
    method: "phone",
    readiness: 72,
    next_contact: "2024-01-19",
    estimated_value: "$980,000",
    last_agent: "Michael Chen",
  ...
  },
  {
    ...
    estimated_value: "$1,100,000",
    last_agent: "Emma Rodriguez",
  ...
  },
  {
    ...
    estimated_value: "$875,000",
    last_agent: "James Williams",
  ...
  {
    id: "5",
    address: "654 Birch Lane, San Francisco, CA 94106",
    last_contacted: "2024-01-05",
    method: "phone",
    readiness: 42,
    next_contact: "2024-01-28",
    estimated_value: "$750,000",
    last_agent: "Lisa Martinez",
  ...
  {
    id: "6",
    address: "987 Cedar Drive, San Francisco, CA 94107",
    last_contacted: "2024-01-14",
    method: "ai",
    readiness: 88,
    next_contact: "2024-01-21",
    estimated_value: "$1,450,000",
    last_agent: "David Park",
  ...
  {
    id: "7",
    address: "135 Spruce Court, San Francisco, CA 94108",
    last_contacted: "2024-01-11",
    method: "door",
    readiness: 76,
    next_contact: "2024-01-18",
    estimated_value: "$1,025,000",
    last_agent: "Angela Thompson",
  ...
  {
    id: "8",
    address: "246 Willow Street, San Francisco, CA 94109",
    last_contacted: "2024-01-09",
    method: "phone",
    readiness: 68,
    next_contact: "2024-01-23",
    estimated_value: "$920,000",
    last_agent: "Kevin Zhang",
  ...
  {
    id: "9",
    address: "357 Ash Boulevard, San Francisco, CA 94110",
    last_contacted: "2024-01-13",
    method: "ai",
    readiness: 82,
    next_contact: "2024-01-20",
    estimated_value: "$1,200,000",
    last_agent: "Rachel Green",
  ...
  {
    id: "10",
    address: "468 Poplar Lane, San Francisco, CA 94111",
    last_contacted: "2024-01-07",
    method: "door",
    readiness: 50,
    next_contact: "2024-01-26",
    estimated_value: "$850,000",
    last_agent: "Tom Brady",
  ...
  {
    id: "11",
    address: "579 Hemlock Road, San Francisco, CA 94112",
    last_contacted: "2024-01-16",
    method: "phone",
    readiness: 92,
    next_contact: "2024-01-23",
    estimated_value: "$1,600,000",
    last_agent: "Nicole Adams",
  ...
  {
    id: "12",
    address: "681 Fir Street, San Francisco, CA 94113",
    last_contacted: "2024-01-06",
    method: "ai",
    readiness: 45,
    next_contact: "2024-01-27",
    estimated_value: "$780,000",
    last_agent: "Mark Wilson",
  ...
  {
    id: "13",
    address: "792 Cypress Avenue, San Francisco, CA 94114",
    last_contacted: "2024-01-04",
    method: "door",
    readiness: 35,
    next_contact: "2024-01-30",
    estimated_value: "$650,000",
    last_agent: "Susan Blake",
  ...
  {
    id: "14",
    address: "814 Juniper Drive, San Francisco, CA 94115",
    last_contacted: "2024-01-17",
    method: "phone",
    readiness: 79,
    next_contact: "2024-01-24",
    estimated_value: "$1,150,000",
    last_agent: "Christopher Lee",
  ...
  {
    id: "15",
    address: "925 Magnolia Street, San Francisco, CA 94116",
    last_contacted: "2024-01-02",
    method: "ai",
    readiness: 58,
    next_contact: "2024-01-29",
    estimated_value: "$900,000",
    last_agent: "Patricia Moore",
  ...
  {
    id: "16",
    address: "1036 Sycamore Lane, San Francisco, CA 94117",
    last_contacted: "2024-01-18",
    method: "door",
    readiness: 86,
    next_contact: "2024-01-25",
    estimated_value: "$1,350,000",
    last_agent: "Robert Hall",
  ...
  {
    id: "17",
    address: "1147 Walnut Road, San Francisco, CA 94118",
    last_contacted: "2024-01-03",
    method: "phone",
    readiness: 40,
    next_contact: "2024-02-01",
    estimated_value: "$700,000",
    last_agent: "Jennifer Smith",
  ...
  {
    id: "18",
    address: "1258 Hickory Street, San Francisco, CA 94119",
    last_contacted: "2024-01-19",
    method: "ai",
    readiness: 74,
    next_contact: "2024-01-26",
    estimated_value: "$1,050,000",
    last_agent: "Daniel Foster",
  ...
  {
    id: "19",
    address: "1369 Ash Street, San Francisco, CA 94120",
    last_contacted: "2024-01-20",
    method: "door",
    readiness: 89,
    next_contact: "2024-01-27",
    estimated_value: "$1,500,000",
    last_agent: "Barbara Clark",
  ...
  {
    id: "20",
    address: "1470 Locust Avenue, San Francisco, CA 94121",
    last_contacted: "2024-01-01",
    method: "phone",
    readiness: 38,
    next_contact: "2024-02-02",
    estimated_value: "$725,000",
    last_agent: "Paul Davis",
